...
/**
 * One-phrase verdict from a sentiment tally (Phase 6 stock page).
 */
export function overallMood(counts) {
  if (counts.bullish > counts.bearish) return "leaning bullish";
  if (counts.bearish > counts.bullish) return "leaning bearish";
